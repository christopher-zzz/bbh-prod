...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring("file:AODstep1.root"),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step2 nevts:15'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:bbh_Fall17_mXHMASSX_AOD.root'),
